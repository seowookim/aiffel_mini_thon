...
train_df = pd.DataFrame(extract_data(train_df_org))
valid_df = pd.DataFrame(extract_data(valid_df_org))
...
def train():
  ...
  training_args = TrainingArguments(
      fp16=True,
      output_dir=f'./results_{modelNm}_gen_no_lora_{DATA_SIZE}',
  ...
  model_path = f'./models/kogpt2_chatbot_no_lora_{DATA_SIZE}'
